...
Image1(1).MouseIcon = Label4.MouseIcon
    lblDescription.Caption = "程序說明：開發中。。。感謝冰藍論壇,令狐心情,游泳的魚,wind,susu所有支持者！(許多數據都由他們提供) -------chaoliu最後修改於2004-10-4" & vbCrLf & vbCrLf & "潮流工作室出品http://www.chao6.com"
    lblDisclaimer.Caption = "警告:“金庸群俠傳”版權歸屬河洛小組，用本程序獲取的遊戲圖片不可做商業用途！.....潮流工作室"
