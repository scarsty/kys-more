...
Private Sub cmdok_Click()
    ...
    kk.Data(1) = userN.Value + userX.Value * 2 + userY.Value * 4 + txtMax.Text * 256
    kk.Data(2) = userN.Text
    kk.Data(3) = userS.Text
    kk.Data(4) = userX.Text
    kk.Data(5) = userY.Text
    kk.Data(6) = userR.Text
