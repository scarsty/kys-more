...
if a<=0 then
	...
	DarkScence();
	putscencemappro(4324*2,68,1,41,34);
	putscencemappro(3560*2,68,1,41,33);
	putscencemappro(1260*2,68,1,42,34);
	putscencemappro(1260*2,68,1,42,33);
	putscencemappro(1260*2,68,1,41,32);
	putscencemappro(2596*2,68,1,43,33);
	putscencemappro(3043*2,68,1,42,31);
	putscencemappro(3186*2,68,1,43,35);
	putscencemappro(3021*2,68,1,41,36);
	setscenceface(3);
	LightScence();
	...
	darkscence();
	putscencemappro(0,68,1,41,34);
	putscencemappro(0,68,1,41,33);
	putscencemappro(0,68,1,42,34);
	putscencemappro(0,68,1,42,33);
	putscencemappro(0,68,1,41,32);
	putscencemappro(0,68,1,43,33);
	putscencemappro(0,68,1,42,31);
	putscencemappro(0,68,1,43,35);
	putscencemappro(0,68,1,41,36);
	lightscence();
end
exit();
