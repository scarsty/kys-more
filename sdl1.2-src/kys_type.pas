  ...
  TBattleRole = record
    case TCallType of
      Element: (rnum, Team, Y, X, Face, Dead, Step, Acted: smallint;
        Pic, ShowNumber, AntiHurt, AutoMode, PreTeam, ExpGot, Auto: smallint;
...
var
  ...
  FPNGTile: array[0..1000] of TSurfaceArray;
