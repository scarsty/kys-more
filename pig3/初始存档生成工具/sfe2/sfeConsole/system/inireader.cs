...
namespace imzopr
{
    ...
    public class inireader:AsmResource
    {
        ...
        public inireader(string StreamFromAssembly)
        {
            //filestream = ReadStreamFromAssembly(StreamFromAssembly);
            filestream = new FileStream(StreamFromAssembly, FileMode.Open);
            returnvalue = new Dictionary<string, returnDic>();
            try
            {
                ReadAllsection();
