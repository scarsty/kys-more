...
function SDL_sqrtf(x: single): single; lSDL;
function SDL_tan(x: double): double; lSDL;
function SDL_tanf(x: single): single; lSDL;
...
function SDL_SwapFloat(const x: single): single; inline;
...
function SDL_SwapFloatLE(const x: single): single; inline;
...
function SDL_SwapFloatBE(const x: single): single; inline;
...
function SDL_GetDisplayDPI(displayIndex: longint; ddpi, hdpi, vdpi: psingle): longint; lSDL;
...
function SDL_GL_SetAttribute(attr: TSDL_GLattr; value: longint): longint; lSDL;
function SDL_GL_GetAttribute(attr: TSDL_GLattr; value: plongint): longint; lSDL;
...
function SDL_JoystickFromInstanceID(joyid: TSDL_JoystickID): PSDL_Joystick; lSDL;
...
function SDL_JoystickCurrentPowerLevel(joystick: PSDL_Joystick): TSDL_JoystickPowerLevel; lSDL;
...
function SDL_GameControllerFromInstanceID(joyid: TSDL_JoystickID): PSDL_GameController; lSDL;
...
function SDL_GameControllerGetAxisFromString(pchString: PAnsiChar):TSDL_GameControllerAxis; lSDL;
function SDL_GameControllerGetStringForAxis(axis: TSDL_GameControllerAxis): PAnsiChar; lSDL;
function SDL_GameControllerGetBindForAxis(gamecontroller: PSDL_GameController; axis: TSDL_GameControllerAxis): TSDL_GameControllerButtonBind; lSDL;
function SDL_GameControllerGetAxis(gamecontroller: PSDL_GameController; axis: TSDL_GameControllerAxis): Sint16; lSDL;
function SDL_GameControllerGetButtonFromString(pchString: PAnsiChar): Uint32; lSDL;
function SDL_GameControllerGetStringForButton(button: TSDL_GameControllerButton): PAnsiChar; lSDL;
function SDL_GameControllerGetBindForButton(gamecontroller: PSDL_GameController; button: TSDL_GameControllerButton): TSDL_GameControllerButtonBind; lSDL;
function SDL_GameControllerGetButton(gamecontroller: PSDL_GameController; button: TSDL_GameControllerButton): Uint8; lSDL;
...
function SDL_RenderGetD3D9Device(renderer: PSDL_Renderer): PIDirect3DDevice9; lSDL;
function SDL_DXGIGetOutputInfo(displayIndex: longint; adapterIndex, outputIndex: plongint): SDL_bool; lSDL;
{$ENDIF}

{$IFDEF IPHONEOS}
function SDL_SDL_iOSSetAnimationCallback(window: PSDL_Window; interval: longint; callback, callbackParam: pointer); inline;
function SDL_iPhoneSetAnimationCallback(window: PSDL_Window; interval: longint; callback, callbackParam: pointer): longint; lSDL;
...
function SDL_iOSSetAnimationCallback(window: PSDL_Window; interval: longint; callback, callbackParam: pointer): longint; inline;
begin
  exit(SDL_iPhoneSetAnimationCallback(window, interval, callback, callbackParam));
end;
